  ...
  <section class="py-24 px-8">
    <div class="max-w-6xl mx-auto">
      ...
      <div class="text-center">
        ...
        <p class="text-muted font-rounded mt-6 mb-10 text-lg">
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          class="inline-flex items-center gap-2.5 bg-dark text-white font-rounded font-medium px-7 py-3.5 rounded-full hover:bg-dark/85 transition-colors"
        >
